...
all: clean
	...
	source $(PWD)/venv/bin/activate && python3 $(PWD)/src/console.py appdir apprepo python3.8 python3.8-dev python3-psutil python3-pip python3-setuptools python3-apt openssl libffi7 intltool libgudev-1.0-0 --destination=$(PWD)/build
